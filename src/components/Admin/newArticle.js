...
function NewArticle() {
  ...
  useEffect(() => {
    fileList();
      ...
      const addArticle = (data, event) => {
        ...
        console.log(datas)
        fetch(`https://backtennis.herokuapp.com/articles/secure/add`, {
      method: 'POST',
  ...
  return (
   <div className="newBandeau" id="newArticle">
    <div><h3 className="admin_subtitle">Ajouter un article</h3></div>
              <form ref={form} id="add_form" className="form" onSubmit={handleSubmit(addArticle)}>
 ...
 backgroundRepeat: 'no-repeat', width: '100%', height: '17rem' }}></div> <input type="hidden" name="addressImg" className="input_date" value={img} readOnly />
 <div>
 <div className="form_upload">
