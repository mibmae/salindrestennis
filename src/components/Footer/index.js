  ...
  return (
    <div className="footer">
      ...
      <div id="coordonnees" className="contacts">
        ...
        <div className="gmap">
          <a href="https://www.google.com/maps/place/As+Salindres+Tennis/@44.1656946,4.1588741,17z/data=!4m5!3m4!1s0x12b444af026d3b7b:0x853a4463a488a269!8m2!3d44.1656379!4d4.1587924" target="_blank"><img src={gmaps} className="map" /></a>
    </div>
